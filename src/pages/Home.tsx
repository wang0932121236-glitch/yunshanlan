    ...
    <div>
      ...
      <div className="md:hidden relative w-full overflow-hidden" style={{ marginTop: '64px', background: '#1c1917' }}>
        <img
          ...
          style={{ display: 'block', objectFit: 'cover', objectPosition: 'center bottom', height: 'calc(100svh - 64px - 280px)' }}
        />
      ...
      {/* ── Hero ── */}
      {/* Mobile: GIF top, text bottom stacked; Desktop: side by side */}
      <div className="relative w-full overflow-hidden" style={{ background: '#fafaf8' }}>
        ...
        <div className="md:hidden flex flex-col">
          ...
          <div className="flex flex-col items-center text-center px-6 py-8">
            <p className="text-amber-700/70 text-[9px] tracking-[0.3em] uppercase font-body font-medium mb-3">Yunnan · China</p>
            <h1 className="font-heading italic text-3xl text-stone-900 leading-tight mb-3">
              Discover the<br />
              <span className="text-gradient-gold">Soul of Yunnan</span>
            </h1>
            <div className="w-10 h-px bg-gradient-to-r from-amber-700/50 to-amber-700/20 mb-4" />
            <p className="text-stone-400 text-xs leading-relaxed font-body mb-6 max-w-xs">
            ...
            <div className="flex flex-col gap-2 w-full max-w-xs">
              <Link to="/routes" className="rounded-full px-6 py-3 text-xs font-semibold text-stone-800 border border-b8956a/45 hover:bg-amber-50/80 transition-all duration-200 flex items-center justify-center gap-2 font-body shadow-sm">
                Explore Routes <ArrowRight size={12} />
              </Link>
              <Link to="/destinations" className="rounded-full px-6 py-3 text-xs font-semibold text-stone-400 hover:text-stone-800 transition-all duration-200 text-center font-body">
                View Destinations
              </Link>
            </div>
          </div>
        ...
        <div className="hidden md:flex items-center justify-center" style={{ height: '100svh' }}>
          ...
          {/* Left: GIF */}
          <div className="flex-1 flex items-center justify-center h-full px-12 py-20">
            <div
            ...
            >
              <div className="relative overflow-hidden" style={{ borderRadius: '16px', background: '#0a0a0a' }}>
                <img
                  src={POSTER_BG}
                  alt=""
          ...
          {/* Right: Text */}
          <div className="flex-1 flex items-center justify-center h-full pr-16 pl-4">
            <div className="max-w-md flex flex-col items-center md:items-start">
              ...
              >
                <Link to="/routes" className="rounded-full px-8 py-3.5 text-sm font-semibold text-stone-800 border border-b8956a/45 hover:bg-amber-50/80 transition-all duration-200 flex items-center gap-2 text-center justify-center font-body shadow-sm" style={{ boxShadow: '0 2px 12px rgba(201,164,88,0.15)' }}>
                  Explore Routes <ArrowRight size={14} />
                </Link>
                <Link to="/destinations" className="rounded-full px-8 py-3.5 text-sm font-semibold text-stone-400 hover:text-stone-800 transition-all duration-200 text-center font-body">
                  View Destinations
                </Link>
              </motion.div>
